...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Application Payment stripe keys
    |--------------------------------------------------------------------------
    */
    'stripe_key' => (string) env('STRIPE_KEY'),
    'stripe_secret' => (string) env('STRIPE_SECRET'),

    'sms_base_url' => (string) env('SMS_BASE_URL'),
    'sms_user_name' => (string) env('SMS_USER_NAME'),
    'sms_password' => (string) env('SMS_PASSWORD'),
    'sms_originator' => (string) env('SMS_ORIGINATOR'),
    'sms_route' => (string) env('SMS_ROUTE'),
